...
#cat $service_status_tmp_file_3 | grep -v "problem_has_been_acknowledged=1" | grep "CRITICAL\|WARNING" | sed 's/plugin_output=//g' | sed 's/service_description=//g' | sed 's/problem_has_been_acknowledged=0//g' > $service_status_tmp_file_4
