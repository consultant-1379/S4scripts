...
if [[ $SERVER_STATUS == "UNAVAILABLE FOR SHARED ACCESS" ]];then
  server_status_color="#ff8c0a"
  server_status_H="H2"
fi
...
<center>
    <table class="myTableA">
		...
		<tbody>
			...
			<tr>
				<td><strong>NSS Simulations:</strong></td>
                <td></td>
				<td>$nss_version</td>
			</tr>
			<tr>
			...
			<tr>
				<td><strong>Genstats:</strong></td>
                <td></td>
				<td>$genstats_version</td>
			</tr>
			<tr>
...
cat <<_EOFextra >>$MAIL_BODY
                                                    ...
                                                    <td width="500" valign="top">
                                                        <table width="460" border="0" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td valign="top" style="font-family:Arial, Helvetica, sans-serif; color:#181818;font-size:14px; line-height:18px;"> 	
                                                                    <p>
                                                                        <!--Please see <a href="https://confluence-oss.seli.wh.rnd.internal.ericsson.com/display/CI/DE+Test+Services+%3A+Team+Grifone" target="_blank">TEAM GRIFONE DEPLOYMENTS CALENDAR</a> for todays planned activities. 
                                                                        <br>
                                                                        <br>-->
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="500">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="font-family:Arial, Helvetica, sans-serif; color:#181818;font-size:14px; line-height:17px;"
                                                    valign="top" width="185">
                                            <tr bgcolor="#fafafa">
                                                <td width="20">&nbsp;</td>
                                                <td width="600"
                                                    style="font-family:Arial, Helvetica, sans-serif; color:#181818;font-size:14px; line-height:14px; text-transform:uppercase;"
                                                    valign="top">OMBS BACKUP STATUS
                                                </td>
                                                <td width="20">&nbsp;</td>
                                            </tr>
                                            <tr bgcolor="#fafafa">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="500" valign="top">
                                                                <table width="460" border="0" cellpadding="0"
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top"
                                                                            style="font-family:Arial, Helvetica, sans-serif; color:#181818;font-size:18px; line-height:22px;">
                                                                        </td>
                                                                    </tr>
                                                                    <!--Spacing-->
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top"
                                                                            style="font-family:Arial, Helvetica, sans-serif; color:#181818;font-size:14px; line-height:18px;">
                                                                            <p>
_EOFextra
if [ $clusterId == "429" ] || [ $clusterId == "623" ] || [ $clusterId == "660" ];
then
...
cat <<_EOF0 >>$MAIL_BODY
                    ...
                    <tr bgcolor="#181818">
                        ...
                        <td width="600" valign="top">
							...
							<a href="https://confluence-oss.seli.wh.rnd.internal.ericsson.com/display/CI/DE+Test+Services+%3A+Team+Grifone" target="_blank">Team Grifone</a> 
                                                    </td>
                                                </tr>
                                                <!--end content-->
                                                <!--Spacing-->
