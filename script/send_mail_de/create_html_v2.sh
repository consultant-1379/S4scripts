...
<h2><strong><span style="color: #ffffff;">NOTIFICATION FROM DE TEST SERVICES</span></strong></h2>
...
<p>For more information please contact: <a href="mailto: $mail_contact">$de_team_name</a></p>
</td>
</tr>
</tbody>
</table>
