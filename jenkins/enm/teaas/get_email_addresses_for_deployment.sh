...
QUERY_URL="https://jira-nam.lmera.ericsson.se:443/rest/api/2/search?jql=project=CIP%20AND%20component=TEaaS%20AND%20$TICKET_STATUS_QUERY%20AND%20%22DE%20Team%20Name%22=%22S4(Performance)%22$ENVIRONMENT_QUERY&fields=$JIRA_USER_TYPES&maxResults=1000"
