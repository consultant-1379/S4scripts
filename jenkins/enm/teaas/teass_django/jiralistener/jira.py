...
def search_for_issues(json_for_query):
    jira_url = "https://jira-nam.lmera.ericsson.se:443/rest/api/2/search"
...
class Jira_Issue:
    ...
    def get_transition_id(self, status):
        jira_transitions_url = "https://jira-nam.lmera.ericsson.se:443/rest/api/2/issue/{}/transitions".format(self.get_key())
    ...
    def set_status(self, to_value):
        ...
        jira_url = "https://jira-nam.lmera.ericsson.se:443/rest/api/2/issue/{}/transitions".format(self.get_key())
        headers = {'Content-type': 'application/json'}
    ...
    def add_comment(self, comment, user):
        jira_url = "https://jira-nam.lmera.ericsson.se:443/rest/api/2/issue/{}/comment".format(self.get_key())
        headers = {'Content-type': 'application/json'}
