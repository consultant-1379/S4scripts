...
enm_login=$(sshpass -p 12shroot ssh nagios@$lms_ip "sudo curl -k --request POST \"https://$http_url/login\" -d IDToken1=\"administrator\" -d IDToken2=\"S4_Passw0rd\" --cookie-jar cookie.txt")
